...
urlpatterns = [
    ...
    path("documents/upload/", admin_views.source_document_upload, name="source_document_upload"),
    path("documents/<int:pk>/edit/", admin_views.source_document_edit, name="source_document_edit"),
