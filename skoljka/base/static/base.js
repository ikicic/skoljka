...
var THEMES = {
  'skoljka-classic': {
    ...
    properties: {
      ...
      '--solution-table-tr-bg-color': 'unset',
      '--solution-table-tr-border-bottom': 'none',
    }
  },
  'skoljka-dark': {
    name: 'Školjka Dark',
    ...
    properties: {
      ...
      '--input-box-shadow': 'inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 8px rgba(231, 231, 231, 0.6)',
      ...
      '--solution-table-tr-border-bottom': '1px solid #444',
    }
  },
  'purple-neon': {
    name: 'Neon Purple',
    identifier: 'purple-neon',
    author: 'Dario Vuksan',
    href: 'https://github.com/IamMusavaRibica/',
    div: null,
    ...
    properties: {
      ...
      '--skoljka-logo-background': '-webkit-linear-gradient(47deg, #F05A28 8%, #ff1e00 26%, #d622ff 64%)',
      '--skoljka-logo-text-color-hover': '#ff00f2',
      '--skoljka-logo-text-shadow': 'none',
      '--body-bg': '#100016',
      '--header-box-shadow': 'none',
      '--outset-bg': '#400452',
      '--outset-box-shadow': 'none',
      '--outset-border': 'none',
      '--outdiv-bg': '#500369',
      '--outdiv-box-shadow': 'none',
      '--outdiv-border': '1px solid #761894',
      '--text-color': '#f2cbff',
      '--content-bg-color': '#1e022a',
      '--sidebar-bg-color': '#1e022a',
      '--content-border': '1px solid #b733ec',
      '--sidebar-border': '1px solid #b733ec',
      ...
      '--caction-info-text-color': '#dedede',
      '--task-file-info-text-color': '#dedede',
      '--task-action-bar-bg': '#501a5d',
      '--comp-my-team-td-bg-color': '#314f25',
      '--nav-anchor-bg-color-hover': '#2d073c',
      '--blue-anchor-color': '#e720ed',
      '--blue-anchor-color-hover': '#e720ed',
      '--red-anchor-color-hover': '#ff0000',
      '--profile-task-submitted-anchor': '#ff11f2',
      '--anchor-footer': '#b400ff',
      '--hr-color': '#9d46ab',
      '--striped-table-header-bg-color': '#58005f',
      '--striped-table-odd-row-bg-color': '#390142',
      '--icon-filter': 'invert(180) contrast(150%)',
      '--image-filter': 'invert(180) contrast(150%)',
      '--solution-unhide-box-bg-color': 'inherit',
      '--solution-unhide-box-bg-color-hover': 'rgba(82, 86, 100, 0.45)',
      '--mathcontent-background': '#2f023b',
      '--mathcontent-text-color': '#f9e8ff',
      '--mathcontent-border': 'none',
      '--textarea-background': '#2f023b',
      '--textarea-text-color': '#f9e8ff',
      '--textarea-border': '1px solid #5e1172',
      '--textarea-box-shadow': 'inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 8px #6b1181',
      '--mc-quote-background': '#2d053a',
      '--mc-quote-border-left': '2px solid #750090',
      '--mc-quote-text-color': '#f9e8ff',
      '--bootstrap-btn-text-shadow': 'none',
      '--bootstrap-btn-background': '#a82ff5',
      '--bootstrap-btn-text-color': '#eeeeee',
      '--input-bg-color': '#2f023b',
      '--input-text-color': '#f9e8ff',
      '--input-border': '1px solid #5e1172',
      '--input-box-shadow': 'inset 0 1px 1px rgba(0, 0, 0, 0.075), 0 0 8px #6b1181',
      '--alert-bg-color': '#3d2044',
      '--alert-text-shadow': 'none',
      '--alert-border': '1px solid #b67800',
      '--alert-text-color': '#f6ead4',
      '--tag-tooltip-bg': '#171717',
      ...
      '--pagination-anchor-bg-color-hover': '#2f2f2f',
      '--comp-chain-unfinished-hover': '#2d2d36',
      '--outset-code-bg-color': '#230d32',
      '--outset-code-border': '1px solid #140025',
      '--profile-distribution-column-outline': '1px solid #4c0852',
      '--profile-distribution-column-bg-color': '#300142',
      '--profile-distribution-column-fg-color': '#541d65',
      '--solution-table-tr-bg-color': 'transparent !important',
      '--solution-table-tr-border-bottom': '1px solid #642e6e',
