...
class UserViewsTestCase(TestCase):
    ...
    def test_registration_and_login(self):
        ...
        response = c.post('/accounts/login/', {  # Inactive users cannot login.
            'username': 'testaccount',
            'password': 'testpwd',
        })
        ...
        self.assertTrue(response.redirect_chain[0][0].endswith('/accounts/activate/complete/'))
        ...
        self.assertEqual(len(response.redirect_chain), 1)
        self.assertRegex(response.redirect_chain[0][0], r'https?://[a-z.]+/', "Should go to home page.")
